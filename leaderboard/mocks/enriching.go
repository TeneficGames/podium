...
func (mr *MockEnricherCacheMockRecorder) Get(ctx, tenantID, members any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockEnricherCacheMockRecorder) Set(ctx, tenantID, members, ttl any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
