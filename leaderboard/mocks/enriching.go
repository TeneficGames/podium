...
//
//	mockgen -source=leaderboard/enriching/interfaces.go -destination=leaderboard/mocks/enriching.go
//
...
import (
	...
	model "github.com/TeneficGames/podium/leaderboard/model"
...
func (mr *MockEnricherMockRecorder) Enrich(ctx, tenantID, leaderboardID, members any) *gomock.Call {
...
func (mr *MockEnricherCacheMockRecorder) Get(ctx, tenantID, leaderboardID, members any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockEnricherCacheMockRecorder) Set(ctx, tenantID, leaderboardID, members, ttl any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
